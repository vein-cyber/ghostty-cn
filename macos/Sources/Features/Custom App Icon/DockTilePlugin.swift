...
class DockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    #if DEBUG
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.vein-cyber.ghostty-cn.debug")
    #else
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.vein-cyber.ghostty-cn")
    #endif
