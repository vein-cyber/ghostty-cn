    ...
    @IBAction override func closeWindow(_ sender: Any?) {
        ...
        Task {
            let alert = NSAlert.reviewWindowsAlert(
                messageText: String(localized: "You have \(confirmControllers.count) windows with running processes. Do you want to review these windows before closing?"),
                terminateNowButtonTitle: String(localized: "Close")
            )
